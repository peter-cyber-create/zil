...
const Hero = () => {
  return (
    <div className='w-full mt-5'>
        {/* Heading Hero */}
        <h1 className='text-center text-3xl md:text-4xl font-bold text-green-600'>Our <span className='text-[#444444]'>Capabilities</span> and <span className='text-[#444444]'> Services</span></h1>
        {/* Carousel Hero */}
        
        {/* <HeroCarousel /> */}
        <SampleCarousel servicesData={servicesData} />
        {/* Core values Hero */}
        <div className="bg-green-700 text-gray-300 text-center grid grid-cols-1 md:grid-cols-2 lg:py-20 py-10 px-6 space-y-10 gap-8 items-stretch">
         ...
         <div className="flex justify-center items-center gap-4 text-center">
          ...
          <p className='text-center px-4'>To consistently engage in acts of compassion and kindness, uplifting lives—especially those of widows and orphans—through sustainable support and empowerment. At Zodongo International Limited, our work is only just beginning. With faith, passion, and purpose, we continue to rise—together—with the communities we serve.
