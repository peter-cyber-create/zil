      ...
      <Body style={main}>
        ...
        <Container style={container}>
          ...
          <Text style={paragraph}>
            I'm reaching out to Zodongo International Limited from your website.
            {message}
          </Text>
          ...
          <Text style={footer}>
            Email: info@zodongo-int.com | Website: www.zodongo-int.com
          </Text>
          <Text style={footer}>
            Phone: +256 779 201 606, +256 779 933 268, +256 772 255 109
          </Text>
          <Text style={footer}>
            P.O.Box 149549 Athina club house Kololo, Kampala, Uganda
          </Text>
        </Container>
      </Body>
    </Html>
